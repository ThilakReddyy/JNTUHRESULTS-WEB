  ...
  return (
    <>
      ...
      <meta
        ...
        content="JNTUH Results, JNTUH B.Tech Results, jntuhresults, jntuh notifications, JNTUH Results Engineering, JNTUH Engineering Results, jntuh bpharmacy results, jntuh bphar results, jntuh mtech results, jntuh mba results, jntuh mca results, jntuh all semester results, jntuh all semester results r18"
      />
      <meta
        name="description"
        content="Find the results of your entire semesters at Jawaharlal Nehru Technological University, Hyderabad (JNTUH). Get JNTUH B.Tech results, notifications, and more."
      />
      <meta
