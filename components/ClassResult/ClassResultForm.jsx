...
const ClassReportForm = ({ warning, submit, form, setForm }) => {
  ...
  const handleSetHallticketChange = (value) => {
    console.log("handle ahll");
    setForm((prevForm) => ({
      ...prevForm,
      hallticketNo: value,
    }));
  ...
  return (
    <div
      className={`${
        banner ? "ms:h-auto" : "ms:h-screen"
      } ms:h-screen bg-gradient-to-br from-indigo-50 via-white to-cyan-100 md:py-[150px] pt-[75px]`}
    >
          ...
          <center className="py-[35px]">
            ...
            <div className="px-[10%] md:px-[30%] text-xs ">
              ...
              >
                ...
                {Object.keys(data)
                  .sort((a, b) =>
                    data[a].toUpperCase().localeCompare(data[b].toUpperCase()),
                  )
                  .map((key) => {
                    return (
                      <option
              ...
              <div className="text-xs ">
                <input
                  ...
                  onChange={(event) => {
                    ...
                    handleSetHallticketChange(event.target.value);
                  }}
                  maxLength={10}
                  placeholder="Verify your college by entering your htno"
                  className="bg-[#EFEFEF] w-[100%] py-[4px] border border-[#CCCCCC] mt-[5px] rounded-sm h-[35px] text-center "
                  style={{
            ...
            <br />
            <p className="text-[60%] text-red-600 mx-[10px]">
              {warning}.
              <br />
